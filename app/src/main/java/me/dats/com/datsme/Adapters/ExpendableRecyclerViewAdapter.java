...
public class ExpendableRecyclerViewAdapter extends RecyclerView.Adapter<ExpendableRecyclerViewAdapter.ViewHolder> {
    ...
    private final List<UserAnswers> data;
    private Context context;
    private SparseBooleanArray expandState = new SparseBooleanArray();

    public ExpendableRecyclerViewAdapter(final List<UserAnswers> data) {
        this.data = data;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        DatabaseReference user = FirebaseDatabase.getInstance().getReference().child("Users").child(userAnswer.getSender().toString());
